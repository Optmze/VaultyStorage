...
For more help and queries you can contact me at: ayush.devmail@gmail.com (Optmze)
    ...
    def do_snapshot(self,arg):
        ...
        try:
            ...
            print("{0} {2} succesfully created snapshot! {1}".format(Fore.WHITE,Style.DIM,self.USER))
    ...
    def do_show_snapshots(self,arg):
        ...
        try:
            ...
            print("{0} {2} viewed all available snapshot! {1}".format(Fore.WHITE,Style.DIM,self.USER))
        except:
    ...
    def do_revert(self,arg):
        ...
        try:
            ...
            print("{0} Succesfully reverted to {1}! {2}".format(Fore.WHITE,arg,Style.DIM))
